function [B,H,LH,LK,LA,RH,RK,RA,b,rt,rc,lt,lc] = joint_locations(l0,l1,l2,phi,phi_lh,phi_rh,psi_lh,psi_rh,psi,theta,theta_lh,theta_lk,theta_rh,theta_rk,w,x,y,z)
%JOINT_LOCATIONS
...
if nargout > 1
    ...
    t18 = sin(psi);
    t19 = sin(theta);
    H = [x+l0.*t19;y-l0.*t8.*t13;z+l0.*t2.*t8;1.0];
end
if nargout > 2
    t20 = sin(theta_lh);
    t21 = sin(theta_lk);
    ...
    t52 = -t29;
    t53 = -t31;
    LH = [t33+x;t24+t53+y;t25+t29+z;1.0];
end
if nargout > 3
    t66 = -t34;
    t67 = -t35;
    ...
    t100 = -t80;
    t101 = -t81;
    LK = [t33+t38+t50+t78+t87+t88+x;t24+t36+t40+t41+t53+t54+t68+t90+t95+t100+t101+y;t25+t29+t44+t45+t56+t66+t72+t85+t92+t96+t97+z;1.0];
end
if nargout > 4
    ...
    LA = reshape([mt1,mt2,mt3],4,1);
end
if nargout > 5
    RH = [t26+x;t30+t31+y;t32+t52+z;1.0];
end
if nargout > 6
    t102 = -t83;
    t103 = -t98;
    RK = [t26+t39+t49+t51+t62+t89+x;t30+t31+t37+t42+t69+t74+t76+t79+t82+t91+t102+y;t32+t46+t52+t67+t77+t84+t86+t93+t94+t99+t103+z;1.0];
end
if nargout > 7
...
if nargout > 10
    ...
    rc = [t26+t39+t49+t51+t62+t89+x-(l2.*t4.*t11.*t12.*t19)./2.0+(l2.*t4.*t19.*t22.*t23)./2.0+(l2.*t6.*t7.*t8.*t11.*t23)./2.0+(l2.*t6.*t7.*t8.*t12.*t22)./2.0+(l2.*t8.*t11.*t17.*t18.*t23)./2.0+(l2.*t8.*t12.*t17.*t18.*t22)./2.0+(l2.*t6.*t8.*t11.*t12.*t15.*t18)./2.0-(l2.*t7.*t8.*t11.*t12.*t15.*t17)./2.0-(l2.*t6.*t8.*t15.*t18.*t22.*t23)./2.0+(l2.*t7.*t8.*t15.*t17.*t22.*t23)./2.0;et1+et2;et3+et4;1.0];
end
if nargout > 11
    lt = [t27.*(-1.0./2.0)+t33+t38./2.0-t48./2.0-t60./2.0-t61./2.0+x;t24+t36./2.0+t40./2.0+t41./2.0+t53+t54./2.0-t64./2.0+t68./2.0-t75./2.0-t80./2.0-t81./2.0+y;t25+t29-t34./2.0+t44./2.0+t45./2.0+t56./2.0-t58./2.0-t70./2.0+t72./2.0+t96./2.0+t97./2.0+z;1.0];
end
if nargout > 12
    ...
    lc = [t33+t38+t50+t78+t87+t88+x-(l2.*t3.*t9.*t10.*t19)./2.0+(l2.*t3.*t19.*t20.*t21)./2.0+(l2.*t5.*t7.*t8.*t9.*t21)./2.0+(l2.*t5.*t7.*t8.*t10.*t20)./2.0-(l2.*t8.*t9.*t16.*t18.*t21)./2.0-(l2.*t8.*t10.*t16.*t18.*t20)./2.0-(l2.*t5.*t8.*t9.*t10.*t14.*t18)./2.0-(l2.*t7.*t8.*t9.*t10.*t14.*t16)./2.0+(l2.*t5.*t8.*t14.*t18.*t20.*t21)./2.0+(l2.*t7.*t8.*t14.*t16.*t20.*t21)./2.0;et5+et6;et7+et8;1.0];
end
